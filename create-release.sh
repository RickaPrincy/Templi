...
create_lib_release(){
    ...
    local RELEASE_NAME=templi-lib-linux-x86_64@4.1.0
...
create_cli_release(){
    local RELEASE_NAME=templi-cli-linux-x86_64@4.1.0
    release_path+=("${RELEASE_NAME}")
...
git add --all
git commit -m "release: libtempli@4.1.0 - templi_cli@4.1.0"
git tag -a v4.1.0 -m "templi v4.1.0"

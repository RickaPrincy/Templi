...
create_lib_release(){
    ...
    local RELEASE_NAME=templi-lib-linux-x86_64@4.1.1
...
create_cli_release(){
    local RELEASE_NAME=templi-cli-linux-x86_64@4.1.1
    release_path+=("${RELEASE_NAME}")
...
git add --all
git commit -m "release: libtempli@4.1.1 - templi_cli@4.1.1"
git tag -a v4.1.1 -m "templi v4.1.1"

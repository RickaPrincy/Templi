...
TEST(FsUtils_get_folder_files, basic_test)
{
	...
	std::vector<std::string> exclude_paths = {
		"fixtures/fs_utils/get_folder_files_fixture/folder1/folder1_ignored_file.txt",
		"fixtures/fs_utils/get_folder_files_fixture/ignored_folder",
		"fixtures/fs_utils/get_folder_files_fixture/ignored_file.txt"
	};
